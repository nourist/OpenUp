		...
		<div className="bg-base-200 flex h-[100vh] items-center justify-center p-8">
			<div className="bg-base-100 flex aspect-video h-[calc(100%-140px)] max-w-[calc(100%-64px)] rounded-4xl shadow-lg">
				<div className="w-full p-10 md:w-1/2">
					...
					<input id="email" value={email} onChange={(e) => setEmail(e.target.value)} className="mt-1 mb-4 placeholder:capitalize" placeholder={t('email')} />
					...
					<input
						...
						className="mt-1 mb-4 placeholder:capitalize"
					...
					<input id="name" value={displayName} onChange={(e) => setDisplayName(e.target.value)} className="mt-1 placeholder:capitalize" placeholder={t('display-name')} />
